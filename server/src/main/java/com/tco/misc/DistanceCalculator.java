...
public class DistanceCalculator {
  public int calculate(Float radius, Map<String, String> place1, Map<String, String> place2) {
    double lat1 = Double.parseDouble(place1.get("Latitude"));
    double lon1 = Double.parseDouble(place1.get("Longitude"));
    double lat2 = Double.parseDouble(place2.get("Latitude"));
    double lon2 = Double.parseDouble(place2.get("Longitude"));

    double sinLat1 = Math.sin(lat1);
    double cosLat1 = Math.cos(lat1);
    double sinLat2 = Math.sin(lat2);
    double cosLat2 = Math.cos(lon2);
